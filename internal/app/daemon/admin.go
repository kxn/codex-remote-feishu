...
func (a *App) registerAPIRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /api/setup/feishu/apps/{id}/auto-config/complete", a.requireSetup(a.handleFeishuAppAutoConfigComplete))
	...
	mux.HandleFunc("GET /api/admin/feishu/apps/{id}/permissions/check", a.requireAdmin(a.handleFeishuAppPermissionsCheck))
	...
	mux.HandleFunc("POST /api/admin/feishu/apps/{id}/auto-config/complete", a.requireAdmin(a.handleFeishuAppAutoConfigComplete))
