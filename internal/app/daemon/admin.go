...
func (a *App) registerAPIRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /api/setup/onboarding/machine-integration/complete", a.requireSetup(a.handleOnboardingMachineIntegrationComplete))
	...
	mux.HandleFunc("GET /api/admin/opencode/profiles", a.requireAdmin(a.handleOpenCodeProfilesList))
	mux.HandleFunc("POST /api/admin/opencode/profiles", a.requireAdmin(a.handleOpenCodeProfileCreate))
