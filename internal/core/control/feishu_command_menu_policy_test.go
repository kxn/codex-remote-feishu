...
func TestFeishuMenuGroupClassificationMatchesTaskModel(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			want:    []string{FeishuCommandMode, FeishuCommandReasoning, FeishuCommandModel, FeishuCommandAccess, FeishuCommandPlan, FeishuCommandVerbose, FeishuCommandAutoContinue, FeishuCommandCodexProfile, FeishuCommandClaudeProfile, FeishuCommandGoal, FeishuCommandOpenCodeProfile},
		},
		{
		...
		},
		{
			...
			want:    []string{FeishuCommandGPUStatus, FeishuCommandReview, FeishuCommandPatch, FeishuCommandAutoWhip, FeishuCommandPrimary, FeishuCommandCoworkers, FeishuCommandHistory, FeishuCommandCron, FeishuCommandSendFile},
		},
		{
	...
	if totalVisible != 41 {
		t.Fatalf("unexpected total visible command count: got %d, want 41", totalVisible)
	}
}
