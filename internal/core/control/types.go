...
const (
	...
	ActionRepairCommand               ActionKind = "surface.command.repair"
	ActionRestartCommand              ActionKind = "surface.command.restart"
...
const (
	...
	DaemonCommandRepair                     DaemonCommandKind = "repair.command"
	DaemonCommandRestart                    DaemonCommandKind = "restart.command"
