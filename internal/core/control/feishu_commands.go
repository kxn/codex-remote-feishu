...
var feishuCommandSpecs = []feishuCommandSpec{
	...
	},
	{
		definition: FeishuCommandDefinition{
			...
			ArgumentKind:     FeishuCommandArgumentNone,
			Description:      "打开 normal 模式的工作区与会话主页，里面提供切换、从目录新建、从 GIT URL 新建、从 Worktree 新建、解除接管。",
			ShowInHelp:       true,
			ShowInMenu:       true,
		},
		textExact: []feishuCommandMatch{
	...
	},
	{
		definition: FeishuCommandDefinition{
			...
			ArgumentKind:     FeishuCommandArgumentNone,
			Description:      "打开工作区与会话切换卡；normal 模式下 `/list`、`/use`、`/useall` 都会汇合到这里。",
			ShowInHelp:       true,
			ShowInMenu:       true,
		},
		textExact: []feishuCommandMatch{
	...
	},
	{
		definition: FeishuCommandDefinition{
			...
			ArgumentKind:     FeishuCommandArgumentNone,
			Description:      "对当前会话最新一轮助手回复打开受控修补卡；只支持 normal 模式，且当前实例必须空闲。",
			ShowInHelp:       true,
			ShowInMenu:       true,
		},
		textPrefixes: []feishuCommandPrefixMatch{
